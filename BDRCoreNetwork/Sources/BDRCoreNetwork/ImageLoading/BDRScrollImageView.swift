...
@objc public protocol BDRImageScrollViewDelegate: UIScrollViewDelegate {
    func imageScrollViewDidChangeOrientation(imageScrollView: BDRScrollImageView)
}

open class BDRScrollImageView: UIScrollView {
    ...
    @objc open weak var imageScrollViewDelegate: BDRImageScrollViewDelegate?
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(BDRScrollImageView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    @objc open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(BDRScrollImageView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= minimumZoomScale * BDRScrollImageView.kZoomInFactorFromMinWhenDoubleTap - 0.01 {
            setZoomScale(minimumZoomScale, animated: true)
        } else {
            let center = gestureRecognizer.location(in: gestureRecognizer.view)
            let zoomRect = zoomRectForScale(BDRScrollImageView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
...
extension BDRScrollImageView: UIScrollViewDelegate {
